...
var interp;
buf.push('<div');
buf.push(attrs({ 'id':(worker+'_req_'+ID), "class": ('list-group-item') + ' ' + ((req.duration?'finished':'active')+(req.error?' list-group-item-danger':'')) }, {"class":true,"id":true}));
buf.push('>');
if ( req.duration)
{
